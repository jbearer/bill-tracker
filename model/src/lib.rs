...
//! (Postgre)SQL. These are two different ways of viewing the same data, and they must be kept in
//! sync with care.
//!
...
/// The [`DataSource`](graphql::traits::DataSource) used as a backend for the GraphQL API.
pub use sql::PostgreSqlDataSource as DataSource;
